...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="insert.php" method="POST">
      ...
      <input type="text" name = "idno" placeholder="ID number"><br><br>
      <input type="email" name = "email" placeholder="E-mail address"><br><br>

      Gender:  <select name = "gender" class="gender" required>
    ...
    Job title: <select name = "job" class="job" required>
    ...
    <button type="submit" name="sign-up" class="btn-register">CREATE  NEW ACCOUNT</button>
